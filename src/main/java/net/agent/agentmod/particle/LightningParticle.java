...
public class LightningParticle extends SpriteBillboardParticle {
    public LightningParticle(ClientWorld clientWorld, double x, double y, double z,
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z,
            ...
            return new LightningParticle(world, x, y, z, this.spriteProvider, velocityX, velocityY, velocityZ);
        }
    }
}
