package net.agent.agentmod.world;
...
public class ModConfiguredFeatures {
    // blocks, house, HOW does it look like
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        // register ANY configured features
        ...
        register(context, PINK_GARNET_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldPinkGarnetOres, 3));
        register(context, NETHER_PINK_GARNET_ORE_KEY, Feature.ORE, new OreFeatureConfig(netherPinkGarnetOres, 2));
        register(context, END_PINK_GARNET_ORE_KEY, Feature.ORE, new OreFeatureConfig(endPinkGarnetOres, 1));
    }

    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Agentmod.MOD_ID, name));
    }
